...
class SegNet(nn.Module):
    def __init__(self, input_dim=1, num_classes=2, is_unpooling=True, pretrained_vgg16=False):
        ...
        self.down1 = segnetDown2(self.input_dim, 64)
...
#     model = SegNet(input_dim=1, num_classes=2)
#     pred = model(image)
#     print(pred.shape)
